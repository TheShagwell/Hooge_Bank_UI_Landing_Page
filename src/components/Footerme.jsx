    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`styles.flexStart md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          <img src={logo} alt="hoobank" className="lg:w-[200px] h-[72px] object-contain"/>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e3f">
        <p className="font-poppins form-normal text-center text-[18px] leading-[27px] text-white">
